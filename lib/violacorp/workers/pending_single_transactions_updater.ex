defmodule Violacorp.Workers.PendingSingleTransactionsUpdater do
  import Ecto.Query
  ...
  def perform(params) do
    ...
    if !is_nil(user_id) do
      ...
      request = "?user_id=#{user_id}&account_id=#{account_id}&from_date=#{from_date}&to_date=#{to_date}&status=#{status}&start_index=#{
        start_index
      }&page_size=#{page_size}"
