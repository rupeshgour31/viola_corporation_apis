defmodule Violacorp.Workers.CompanyDisable do
  ...
  alias Violacorp.Workers.CompanyDisable
  import Ecto.Query
  ...
  def perform(params) do
    ...
    if !is_nil(get_bank_account) do
      ...
      if res["status_code"] == "204" or res["status_code"] == "409" do
        ...
        Exq.enqueue(Exq, "company_disable", CompanyDisable, [company_info], max_retries: 1)
      end
    else
