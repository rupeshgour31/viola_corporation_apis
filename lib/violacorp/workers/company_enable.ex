defmodule Violacorp.Workers.CompanyEnable do
  ...
  alias Violacorp.Workers.CompanyEnable
  import Ecto.Query
  ...
  def perform(params) do
    ...
    if !is_nil(get_bank_account) do
      ...
      if res["status_code"] == "204" or res["status_code"] == "409" do
        ...
        Exq.enqueue(Exq, "company_enable", CompanyEnable, [company_info], max_retries: 1)
      end
    else
